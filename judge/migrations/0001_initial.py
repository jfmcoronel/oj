    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(to='judge.Comment', related_name='votes', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('real_start', models.DateTimeField(default=django.utils.timezone.now, verbose_name=b'Start time', db_column='start')),
                ...
                ('contest', models.ForeignKey(related_name='users', verbose_name=b'Associated contest', to='judge.Contest', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(related_name='contest_problems', to='judge.Contest', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participation', models.ForeignKey(related_query_name=b'submission', related_name='submissions', to='judge.ContestParticipation', on_delete=models.CASCADE)),
                ('problem', models.ForeignKey(related_query_name=b'submission', related_name='submissions', to='judge.ContestProblem', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(editable=False, db_index=True)),
                ('level', models.PositiveIntegerField(editable=False, db_index=True)),
                ('parent', mptt.fields.TreeForeignKey(related_name='children', verbose_name=b'Parent item', blank=True, to='judge.NavigationBar', null=True, on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(verbose_name=b'Preferred language', to='judge.Language', on_delete=models.CASCADE)),
                ...
                ('user', models.OneToOneField(verbose_name=b'User associated', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(related_name='ratings', to='judge.Contest', on_delete=models.CASCADE)),
                ('participation', models.OneToOneField(related_name='rating', to='judge.ContestParticipation', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(related_name='ratings', to='judge.Profile', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(verbose_name=b'Submission language', to='judge.Language', on_delete=models.CASCADE)),
                ('problem', models.ForeignKey(to='judge.Problem', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(to='judge.Profile', on_delete=models.CASCADE)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submission', models.ForeignKey(related_name='test_cases', verbose_name=b'Associated submission', to='judge.Submission', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='problem',
            name='group',
            field=models.ForeignKey(verbose_name=b'Problem group', to='judge.ProblemGroup', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='problem',
        ...
        migrations.AddField(
            ...
            name='sender',
            field=models.ForeignKey(related_name='sent_messages', verbose_name=b'Sender', to='judge.Profile', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='privatemessage',
            name='target',
            field=models.ForeignKey(related_name='received_messages', verbose_name=b'Target', to='judge.Profile', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='organization',
            name='registrant',
            field=models.ForeignKey(related_name='registrant+', verbose_name=b'Registrant', to='judge.Profile', help_text=b'User who registered this organization', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='judge',
        ...
        migrations.AddField(
            ...
            name='submission',
            field=models.OneToOneField(related_name='contest', to='judge.Submission', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='contestprofile',
            name='user',
            field=models.OneToOneField(related_query_name=b'contest', related_name='contest_profile', verbose_name=b'User', to='judge.Profile', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='contestproblem',
            name='problem',
            field=models.ForeignKey(related_name='contests', to='judge.Problem', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='contestproblem',
        ...
        migrations.AddField(
            ...
            name='profile',
            field=models.ForeignKey(related_name='history', verbose_name=b'User', to='judge.ContestProfile', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='contest',
        ...
        migrations.AddField(
            ...
            name='voter',
            field=models.ForeignKey(to='judge.Profile', related_name='voted_comments', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='commentvote',
        ...
        migrations.AddField(
            model_name='comment',
            name='author',
            field=models.ForeignKey(verbose_name=b'Commenter', to='judge.Profile', on_delete=models.CASCADE),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='comment',
            name='parent',
            field=mptt.fields.TreeForeignKey(related_name='replies', blank=True, to='judge.Comment', null=True, on_delete=models.CASCADE),
            preserve_default=True,
        ),
    ]
