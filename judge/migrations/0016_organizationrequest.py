    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(to='judge.Organization', related_name='requests', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(to='judge.Profile', related_name='requests', on_delete=models.CASCADE)),
            ],
            options={
            },
            bases=(models.Model,),
